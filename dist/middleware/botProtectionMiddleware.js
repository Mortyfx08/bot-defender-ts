...
const botAnalysis_1 = require("../services/botAnalysis");
// Bot detection rules
const BOT_RULES = {
...
const botProtectionMiddleware = async (req, res, next) => {
    try {
        ...
        const botAnalysisService = await botAnalysis_1.BotAnalysisService.getInstance();
...
exports.default = botProtectionMiddleware;
