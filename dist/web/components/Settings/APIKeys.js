...
function APIKeys() {
    return ((0, jsx_runtime_1.jsx)(polaris_1.Page, { title: "API Keys", children: (0, jsx_runtime_1.jsx)(polaris_1.Card, { children: (0, jsx_runtime_1.jsx)("div", { style: { padding: '16px' }, children: (0, jsx_runtime_1.jsxs)(polaris_1.TextContainer, { children: [(0, jsx_runtime_1.jsx)(polaris_1.Text, { variant: "headingLg", as: "h2", children: "Manage API Keys" }), (0, jsx_runtime_1.jsx)(polaris_1.Text, { as: "p", children: "Configure and manage your API keys for Bot Defender." })] }) }) }) }));
}
